...
namespace PayRollProject.DataModel.Migrations
{
    ...
    [Migration("20251106145630_AddTblCityProvincePerfect")]
    partial class AddTblCityProvincePerfect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayRollProject.Entities.Entities.GeoCounties", b =>
                {
                    b.HasOne("PayRollProject.Entities.Entities.GeoProvinces", "GeoProvinces")
                        .WithMany("GeoCounties")
            ...
            modelBuilder.Entity("PayRollProject.Entities.Entities.GeoDistricts", b =>
                {
                    b.HasOne("PayRollProject.Entities.Entities.GeoCounties", "GeoCounties")
                        .WithMany("GeoDistricts")
                        .HasForeignKey("GeoCounty_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeoCounties");
                });

            modelBuilder.Entity("PayRollProject.Entities.Entities.GeoNeighborhoods", b =>
                {
                    b.HasOne("PayRollProject.Entities.Entities.GeoRuralDistricts", "GeoRuralDistricts")
                        .WithMany("Neighborhoods")
                        .HasForeignKey("GeoRuralDistricts_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeoRuralDistricts");
                });
            ...
            modelBuilder.Entity("PayRollProject.Entities.Entities.GeoRuralDistricts", b =>
                {
                    b.HasOne("PayRollProject.Entities.Entities.GeoDistricts", "GeoDistricts")
